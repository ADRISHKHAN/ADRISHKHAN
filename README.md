...
- 🧠 Strong focus on **DSA, problem-solving & clean architecture**  
- 🌱 Currently learning **Backend Systems, Cloud Basics & Modern JS Frameworks**  
...
### 🔹 Secure PDF Scanner & Redaction Tool  
**_Privacy-Focused Document Processing App_**  
- Scans PDFs to detect **sensitive data** like card numbers, bank details & QR codes  
- Allows user-controlled **selective blurring** before export  
- Focused on **security, UX & automation**

**Tech Stack:** Python, OCR, PDF Processing  

---

### 🔹 Full-Stack Web Application  
**_Scalable Web Platform_**  
- Built complete **frontend + backend** system with authentication  
- Implemented **REST APIs**, database integration & role-based access  
...
**_Learning Through Experiments_**  
- Worked on **classification & prediction models**  
- Hands-on with data preprocessing, model training & evaluation  
- Used real datasets for practical understanding
...
- 📊 Solving **DSA & algorithmic challenges**  
